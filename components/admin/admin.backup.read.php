...
function spp_admin_backup_build_view(array $realmDbMap, ?array $request = null): array
{
    ...
    return array(
        ...
        'target_realm_name' => $targetRealmId > 0 ? spp_realm_display_name($targetRealmId, $realmDbMap) : '',
        'source_realm_name' => $sourceRealmId > 0 ? spp_realm_display_name($sourceRealmId, $realmDbMap) : '',
