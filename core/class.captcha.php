...
class Captcha
{
	var $tmpfolder="core/cache/randimg/"; // writeable by php, migrated to storage/cache/randimg/
	...
	function __construct()
	{
		...
		{
			$this->tmpfolder = rtrim(spp_storage_path('cache/randimg'), '/') . '/';
			$this->ttf_folder = rtrim(spp_storage_path('cache/font'), '/') . '/';
		}
	}
...
//		echo $filename."<br />";
	...
	function make_captcha()
	{
        ...
        {
            $image = imagecreatetruecolor($this->lx, $this->ly);
            $back = imagecolorallocate($image, 245, 245, 245);
            ImageFilledRectangle($image, 0, 0, $this->lx, $this->ly, $back);
        }
